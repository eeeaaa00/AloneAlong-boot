					...
					<div class="row px-5 mx-5 mb-lg-5 justify-content-between">
						...
						<svg class="img" style="background-image: url('../images/${product.pcId}-${product.productId}.png'); background-size: cover; background-position: center"
							...
							<div class="card-body">
								...
								<p class="text-green"><fmt:formatNumber value="${product.productPrice}" pattern="#,###,###"/>원</p>
					...
					<div class="row px-5 mx-5 mb-lg-5 justify-content-between">
						<c:forEach items="${restaurantList}" var="res" varStatus="idx">
							<div class="card shadow-sm mb-lg-5" type="button"
								...
								<div class="contents">
								<svg class="img" style="background-image: url('data:image/jpeg;base64,${res.img64}'); background-size: cover; background-position: center"
														width="100%" height="150px"></svg>
