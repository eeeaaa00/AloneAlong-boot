...
<style>
.cart-item:hover, .cart-item:focus {   background-color:#EEEEEE;  }
</style>
	<!-- Page Content -->
										...
										<div class="col-12 col-md-5">
											<div class="d-flex align-items-center">
												...
												<div class="cart-title text-left ml-3">
													...
													<strong>${cartItem.productName}</strong></a>
												</div>
											</div>
										</div>
										<div class="mt-4 mt-md-0 col-12 col-md-7">
											<div class="align-items-center row">
												...
												<div class="col-md-3 text-center">
													<input class="form-control text-center" name="quantity" type="number" value="${cartItem.quantity}" min="1">
						...
						<div class="mb-5">
							<div class="bg-light py-4 rounded-lg px-4">
								...
								<div class="py-1 pt-3 px-3 row justify-content-between border-bottom">
										<span>상품 금액</span><span>${productsPrice}원</span></div>
								<div class="py-1 pt-3 px-3 row justify-content-between border-bottom">
										<span>배송비</span><span>${shippingFee}원</span></div>
								<div class="py-1 pt-3 px-3 row align-items-end justify-content-between border-bottom">
										<span>합계</span><h4>${totalPrice}원</h4></div>
