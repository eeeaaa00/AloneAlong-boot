...
<div class="py-3 text-center">
	<p>함께 먹기 제안하기 <a type="button" class="btn btn-sm btn-outline-success" href="<c:url value='/together/togetherRegister' />"><small> <i class="fas fa-utensils"></i></small> 등록</a></p>
</div>

</h2>총 <b>${togetherList.size()}</b>개의 함께 먹기가 있습니다.
