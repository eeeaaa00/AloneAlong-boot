...
//			@RequestParam(value="kind",  defaultValue="none") String kind,
//			@RequestParam(value="price",  defaultValue="99999") int price,
//			@RequestParam(value="sex",  defaultValue="none") String sex,
//			@RequestParam(value="age",  defaultValue="none") String age,
...
//		}
//		
//		String priceName = "모든 종류 음식";
//		switch(price) {
//			case 99999 : priceName = "모든 가격대"; break;
